...
app = FastAPI (
    title="Загрузчик ПЛК",
    description="Приложение для загркузки и зпуска на программируемых логических контроллеров на базе встраимваемых операционных систем. В основе лежит универсальность и кроссплатформенность. ПО выполнено в рамках курсового проекта КП.15.02.10.22.09. Подробнее о проекте на GitHubhttps://github.com/sasha0000kr/PLC-Uploader",
    version="0.3",
